        ...
        <div className="form-container" ref={ref}>
            ...
            <div className="form-section-main">
                ...
                <div className="form-inputs-right">
                    ...
                    <div className="form-group radio-group">
                        <label><input type="radio" name="marital_status" value="أعزب" /> أعزب</label>
                        <label><input type="radio" name="marital_status" value="متزوج/متزوجة" /> متزوج / متزوجة</label>
                        <label><input type="radio" name="marital_status" value="أرمل/أرملة" /> أرمل / أرملة</label>
                        <label><input type="radio" name="marital_status" value="مطلق/مطلقة" /> مطلق / مطلقة</label>
            ...
            <div className="declaration-section">
                ...
                <div className="declaration-text">
                    أقر أنا <input type="text" className="inline-input" /> برقم قومي <input type="text" className="inline-input" /> بأن البيانات الواردة في هذه الاستمارة صحيحة علي مسؤوليتي الشخصية مع الالتزام بالقانون الرياضي المصري ولائحة النظام الأساسي لأندية الشركات والمصانع و الوزارات والمصالح الحكومية ووحدات الإدارة المحلية والهيئات العامة وأجهزة الدولة و سلطاتها واللائحة الملاحقة وتعديلاتها
